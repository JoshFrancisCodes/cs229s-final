...
def main():
  results = {"loss": None, "training_throughput_4": None, "training_throughput_12": None, "inference_latency_1": None, "inference_latency_12": None}
  ...
  train_output_12 = run_training(12)
  _, throughput_12 = process_train_output(train_output_12)
  ...
  with open('train_12_results.json', 'w') as f:
